...
class AppPermissionsModelTrainer:
    ...
    def train_model(self):
        ...
        # Train Decision Tree (no scaling required)
        ...
        print(f"App Permissions Decision Tree Accuracy: {accuracy:.2f}")
        ...
        with open('classification_report.txt', 'w') as f:
            f.write("App Permissions Decision Tree Classification Report\n")
            f.write("=" * 60 + "\n")
