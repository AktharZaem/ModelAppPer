...
import json
import numpy as np
from sklearn.svm import SVC  # replaced LogisticRegression with SVC
...
class AppPermissionsModelTrainer:
    ...
    def train_model(self):
        ...
        # Use RBF kernel with probability estimates enabled for downstream metrics
        ...
        print(f"App Permissions SVM Accuracy: {accuracy:.2f}")
        ...
        with open('classification_report.txt', 'w') as f:
            f.write("App Permissions SVM Classification Report\n")
            f.write("=" * 60 + "\n")
        ...
        print("Model and scaler saved as 'app_permissions_svm_model.pkl' and 'app_permissions_scaler.pkl'")
